...
var G__13224 = devtools.prefs.pref(v);
v = G__13224;
continue;
} else {
return v;
...
var and__4036__auto__ = cljs.core.not(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__4036__auto__){
var and__4036__auto____$1 = (!(cljs.core.var_QMARK_(value)));
...
}catch (e13154){var _e__12076__auto__ = e13154;
return false;
}})();
...
}catch (e13158){var _e__12076__auto__ = e13158;
return false;
}})();
...
}catch (e13160){var _e__12076__auto__ = e13160;
return false;
}}
}
});
...
var and__4036__auto____$1 = (!(devtools.formatters.helpers.is_prototype_QMARK_(f)));
if(and__4036__auto____$1){
...
var or__4047__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
var and__4036__auto__ = (function (){var or__4047__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
var vec__13190 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13190,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13190,(1),null);
...
var and__4036__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__4036__auto__)){
...
return cljs.core.some((function (p1__13196_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13196_SHARP_);
}),template);
});
