...
var len__4641__auto___13312 = arguments.length;
var i__4642__auto___13314 = (0);
while(true){
if((i__4642__auto___13314 < len__4641__auto___13312)){
args__4647__auto__.push((arguments[i__4642__auto___13314]));

var G__13315 = (i__4642__auto___13314 + (1));
i__4642__auto___13314 = G__13315;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13234){
...
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13235,G__13236,seq13234__$2);
});
...
if(cljs.core.truth_((function (){var or__4047__auto__ = devtools.formatters.helpers.directly_printable_QMARK_(value);
if(or__4047__auto__){
...
return cljs.core._write(writer__4291__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__4036__auto__ = cljs.core.not(devtools.formatters.printing.already_reference_QMARK_(group));
if(and__4036__auto__){
var or__4047__auto__ = devtools.formatters.helpers.expandable_QMARK_(obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13257_SHARP_){
return (!((cljs.core.meta(p1__13257_SHARP_) == null)));
})))){
...
var map__13265 = opts;
var map__13265__$1 = (((((!((map__13265 == null))))?(((((map__13265.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13265.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13265):map__13265);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13265__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13274){var _e__12076__auto__ = e13274;
return false;
}})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
}catch (e13276){var _e__12076__auto__ = e13276;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13285 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13286 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13286;

try{var map__13287 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13287__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13285;
}});
...
;
var temp__5455__auto___13366 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5455__auto___13366)){
var managed_print_level_13367 = temp__5455__auto___13366;
var _STAR_print_level_STAR__orig_val__13291_13368 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13292_13369 = managed_print_level_13367;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13292_13369;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__13291_13368,_STAR_print_level_STAR__temp_val__13292_13369,managed_print_level_13367,temp__5455__auto___13366,writer,opts,job_fn){
return (function (p1__13289_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13289_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__13291_13368,_STAR_print_level_STAR__temp_val__13292_13369,managed_print_level_13367,temp__5455__auto___13366,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13291_13368;
}} else {
job_fn();
}
