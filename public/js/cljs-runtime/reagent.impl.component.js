...
if((i < len)){
var k = (ks[i]);
var G__23026 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__23027 = (i + (1));
m = G__23026;
i = G__23027;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__22912 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__22912);
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22915 = c;
var G__22915__$1 = (((G__22915 == null))?null:G__22915.prototype);
if((G__22915__$1 == null)){
return null;
} else {
return (G__22915__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22918 = c;
var G__22918__$1 = (((G__22918 == null))?null:G__22918.prototype);
if((G__22918__$1 == null)){
return null;
} else {
return (G__22918__$1["render"]);
}
})() == null)))));
});
...
var G__22926 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__22926) : reagent.impl.component.as_element.call(null,G__22926));
};
...
while (G__23030__i < G__23030__a.length) {G__23030__a[G__23030__i] = arguments[G__23030__i + 0]; ++G__23030__i;}
  args = new cljs.core.IndexedSeq(G__23030__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__22927 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22928 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22928;
...
((reagent.debug.tracking)?reagent.debug.track_console:console).error(cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Error rendering component",cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.component.comp_name())].join('')));
} else {
}
}
}
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22927;
}});
...
return ((function (G__22934,G__22934__$1){
...
var c = this;
var G__22940_23035 = (c["cljsRatom"]);
if((G__22940_23035 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22940_23035);
}
...
var renders_23036 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_23037 = cljs.core.first(cljs.core.vals(renders_23036));
if((cljs.core.count(renders_23036) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_23036))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_23037)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_23037], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__22966 = name;
switch (G__22966) {
case "":
...
var G__22976 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__22976);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__22981 = fiber;
var G__22981__$1 = (((G__22981 == null))?null:(G__22981["type"]));
if((G__22981__$1 == null)){
return null;
} else {
return (G__22981__$1["displayName"]);
}
})();
var parent = (function (){var G__22983 = fiber;
if((G__22983 == null)){
return null;
} else {
return (G__22983["return"]);
}
})();
var path = (function (){var G__22988 = parent;
var G__22988__$1 = (((G__22988 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__22988) : reagent.impl.component.fiber_component_path.call(null,G__22988)));
if((G__22988__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22988__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4047__auto__ = (function (){var G__23002 = c;
if((G__23002 == null)){
return null;
} else {
return (G__23002["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__23004._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4047__auto__ = (function (){var G__23007 = c;
if((G__23007 == null)){
return null;
} else {
return (G__23007["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var or__4047__auto____$1 = (function (){var G__23009 = c;
if((G__23009 == null)){
return null;
} else {
return G__23009._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4047__auto__ = (function (){var G__23011 = instance;
if((G__23011 == null)){
return null;
} else {
return (G__23011["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var G__23012 = instance;
if((G__23012 == null)){
return null;
} else {
return G__23012._currentElement;
}
}
})();
var name = (function (){var G__23013 = elem;
var G__23013__$1 = (((G__23013 == null))?null:(G__23013["type"]));
if((G__23013__$1 == null)){
return null;
} else {
return (G__23013__$1["displayName"]);
}
})();
var owner = (function (){var or__4047__auto__ = (function (){var G__23015 = elem;
if((G__23015 == null)){
return null;
} else {
return (G__23015["_owner"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__23016._owner;
}
}
})();
var path = (function (){var G__23017 = owner;
var G__23017__$1 = (((G__23017 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__23017) : reagent.impl.component.component_path.call(null,G__23017)));
if((G__23017__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23017__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__23018 = c;
var G__23018__$1 = (((G__23018 == null))?null:G__23018.constructor);
if((G__23018__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__23018__$1);
}
}
})();
