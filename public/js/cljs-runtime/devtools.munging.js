...
var o12872 = temp__5455__auto__;
var temp__5455__auto____$1 = (o12872["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o12873 = temp__5455__auto____$1;
return (o12873["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12052__auto__ = f;
return (o__12052__auto__["toString"]).call(o__12052__auto__);
} else {
return "";
}
...
try{var o__12052__auto___13143 = t;
(o__12052__auto___13143["cljs$lang$ctorPrWriter"]).call(o__12052__auto___13143,t,writer);
}catch (e12896){var __13145 = e12896;
}
...
var char_code = (function (){var o__12052__auto__ = (new String(char$));
return (o__12052__auto__["charCodeAt"]).call(o__12052__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12052__auto__ = String;
return (o__12052__auto__["fromCharCode"]).call(o__12052__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12912 = num_code;
switch (G__12912) {
case (1):
return (185);
...
var o__12052__auto__ = String;
return (o__12052__auto__["fromCharCode"]).call(o__12052__auto__,superscript_code);
});
/**
...
}catch (e12925){var _e__12076__auto__ = e12925;
return false;
}})())){
...
var vec__12926 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12926,(0),null);
...
var or__4047__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o12942 = temp__5455__auto__;
var temp__5455__auto____$1 = (o12942["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o12943 = temp__5455__auto____$1;
return (o12943["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___13172 = arguments.length;
var i__4642__auto___13173 = (0);
while(true){
if((i__4642__auto___13173 < len__4641__auto___13172)){
args__4647__auto__.push((arguments[i__4642__auto___13173]));

var G__13179 = (i__4642__auto___13173 + (1));
i__4642__auto___13173 = G__13179;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12946){
var vec__12947 = p__12946;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12947,(0),null);
...
var G__13187 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__13188 = cljs.core.butlast(remaining_tokens);
name_tokens = G__13187;
remaining_tokens = G__13188;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12944){
var G__12945 = cljs.core.first(seq12944);
var seq12944__$1 = cljs.core.next(seq12944);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12945,seq12944__$1);
});
...
var vec__12955 = cljs.core.split_with((function (p1__12954_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12954_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12955,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12955,(1),null);
...
var vec__12967 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12967,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12967,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__13194 = cljs.core.rest(remaining_tokens);
var G__13195 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__13194;
name_tokens = G__13195;
continue;
} else {
...
var vec__13004 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13004,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13004,(1),null);
var vec__13008 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13008,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13008,(1),null);
var vec__13011 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13011,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13011,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13011,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13011,(3),null);
...
var vec__13031 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13031,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13031,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13031,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13031,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13031,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13031,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__13034 = temp__5455__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13034,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13034,(1),null);
var vec__13037 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13037,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13037,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__13043 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__13043) : devtools.munging.parse_fn_info_deep.call(null,G__13043));
})()));
}
} else {
return fn_info;
...
var G__13237 = (arity + (1));
var G__13238 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13047){
var vec__13049 = p__13047;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13049,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13049,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities(f,(function (){var or__4047__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__13063_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__13064_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___13247 = arguments.length;
var i__4642__auto___13248 = (0);
while(true){
if((i__4642__auto___13248 < len__4641__auto___13247)){
args__4647__auto__.push((arguments[i__4642__auto___13248]));

var G__13249 = (i__4642__auto___13248 + (1));
i__4642__auto___13248 = G__13249;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13070){
var vec__13072 = p__13070;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13072,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13068){
var G__13069 = cljs.core.first(seq13068);
var seq13068__$1 = cljs.core.next(seq13068);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13069,seq13068__$1);
});
...
var G__13079 = arg;
var G__13079__$1 = (((G__13079 instanceof cljs.core.Keyword))?G__13079.fqn:null);
switch (G__13079__$1) {
...
return devtools.munging.args_lists_to_strings(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((function (){var or__4047__auto__ = devtools.munging.collect_fn_arities(f);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1((((!(cljs.core.empty_QMARK_(protocol_name))))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1((((!(cljs.core.empty_QMARK_(protocol_method))))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__4047__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
var map__13084 = options;
var map__13084__$1 = (((((!((map__13084 == null))))?(((((map__13084.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13084.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13084):map__13084);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13084__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13084__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13084__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13084__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13085 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13085,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13085,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13085,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13085,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13085,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13085,(5),null);
...
if(cljs.core.truth_(and__4036__auto__)){
return cljs.core.not((function (){var and__4036__auto____$1 = silence_common_protocols_QMARK_;
...
var o__12052__auto__ = f;
return (o__12052__auto__["getBasis"]).call(o__12052__auto__);
});
/**
...
}catch (e13092){var _e__12076__auto__ = e13092;
...
var G__13267 = (obj[cljs.core.first(path)]);
var G__13268 = cljs.core.rest(path);
obj = G__13267;
path = G__13268;
continue;
} else {
...
return (function (accum,p__13104){
var vec__13105 = p__13104;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13105,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13105,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13117){
var vec__13118 = p__13117;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13118,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13118,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13118,(2),null);
...
return (function (p__13123){
var vec__13124 = p__13123;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13124,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13124,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__13124,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__13122_SHARP_){
return (obj[cljs.core.first(p1__13122_SHARP_)]);
});})(name,sorted_matches,vec__13124,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
