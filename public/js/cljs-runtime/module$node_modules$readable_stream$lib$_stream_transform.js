shadow$provide.module$node_modules$readable_stream$lib$_stream_transform=function(global,process,require,module,exports,shadow$shims){function afterTransform(er,data){var ts=this._transformState;ts.transforming=!1;var cb=ts.writecb;if(!cb)return this.emit("error",Error("write callback called multiple times"));ts.writechunk=null;ts.writecb=null;null!=data&&this.push(data);cb(er);er=this._readableState;er.reading=!1;(er.needReadable||er.length<er.highWaterMark)&&this._read(er.highWaterMark)}function Transform(options){if(!(this instanceof
