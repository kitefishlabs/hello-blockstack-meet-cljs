...
var G__23034 = o;
(G__23034[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23069__delegate = function (args){
...
while (G__23070__i < G__23070__a.length) {G__23070__a[G__23070__i] = arguments[G__23070__i + 0]; ++G__23070__i;}
  args = new cljs.core.IndexedSeq(G__23070__a,0,null);
} 
return G__23069__delegate.call(this,args);};
G__23069.cljs$lang$maxFixedArity = 0;
G__23069.cljs$lang$applyTo = (function (arglist__23071){
var args = cljs.core.seq(arglist__23071);
return G__23069__delegate(args);
});
...
var G__23038 = o;
(G__23038[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__23077__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__23077 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__23080__i < G__23080__a.length) {G__23080__a[G__23080__i] = arguments[G__23080__i + 0]; ++G__23080__i;}
  args = new cljs.core.IndexedSeq(G__23080__a,0,null);
} 
return G__23077__delegate.call(this,args);};
G__23077.cljs$lang$maxFixedArity = 0;
G__23077.cljs$lang$applyTo = (function (arglist__23081){
var args = cljs.core.seq(arglist__23081);
return G__23077__delegate(args);
});
...
var G__23041 = props;
var G__23041__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23041,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23041);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23041__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__23042){
...
var props = map__23043__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23043__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__23043,map__23043__$1,props,class$){
return (function (c){
...
});})(map__23043,map__23043__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__23045){
var map__23046 = p__23045;
var map__23046__$1 = (((((!((map__23046 == null))))?(((((map__23046.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23046.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23046):map__23046);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23046__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__23046,map__23046__$1,on_write){
return (function (){
...
});})(node_value,map__23046,map__23046__$1,on_write))
);
} else {
...
var G__23049 = jsprops;
(G__23049["defaultValue"] = value);

(G__23049["onChange"] = ((function (G__23049,v,value,on_change){
return (function (p1__23048_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__23048_SHARP_);
});})(G__23049,v,value,on_change))
);
...
var vec__23051 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23051,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23051,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23051,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___23090 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___23090 == null)){
} else {
var key_23091 = temp__5461__auto___23090;
(jsprops["key"] = key_23091);
}
...
var temp__5461__auto___23092 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___23092 == null)){
} else {
var key_23093 = temp__5461__auto___23092;
reagent.impl.template.oset(jsprops,"key",key_23093);
}
...
var G__23055 = reagent.impl.template.__GT_NativeWrapper();
(G__23055["name"] = c);
...
var G__23056 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__23056) : reagent.impl.template.as_element.call(null,G__23056));
} else {
...
var len__4641__auto___23116 = arguments.length;
var i__4642__auto___23117 = (0);
while(true){
if((i__4642__auto___23117 < len__4641__auto___23116)){
args__4647__auto__.push((arguments[i__4642__auto___23117]));

var G__23118 = (i__4642__auto___23117 + (1));
i__4642__auto___23117 = G__23118;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23058){
var G__23059 = cljs.core.first(seq23058);
var seq23058__$1 = cljs.core.next(seq23058);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23059,seq23058__$1);
});
...
break;
default:
var G__23122 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__23122;
continue;
...
var n__4518__auto___23127 = a.length;
var i_23128 = (0);
while(true){
if((i_23128 < n__4518__auto___23127)){
(a[i_23128] = reagent.impl.template.as_element((a[i_23128])));

var G__23129 = (i_23128 + (1));
i_23128 = G__23129;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4518__auto___23131 = a.length;
var i_23132 = (0);
while(true){
if((i_23132 < n__4518__auto___23131)){
var val_23135 = (a[i_23132]);
if(((cljs.core.vector_QMARK_(val_23135)) && ((reagent.impl.template.key_from_vec(val_23135) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_23132] = reagent.impl.template.as_element(val_23135));

var G__23137 = (i_23132 + (1));
i_23132 = G__23137;
continue;
} else {
}
...
var ctx = ({});
var vec__23062 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23062,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23062,(1),null);
...
var G__23065 = (cljs.core.count(argv) - first_child);
switch (G__23065) {
case (0):
...
case (1):
var G__23066 = comp;
var G__23067 = jsprops;
var G__23068 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__23066,G__23067,G__23068);
